...
enum [[deprecated]] : int {
    ...
    SBK_QTGUI_QMAP_QFONT_TAG_QUINT32_IDX                     = 10, // QMap<QFont::Tag,quint32>
    SBK_QTGUI_QMAP_QFONT_TAG_FLOAT_IDX                       = 11, // QMap<QFont::Tag,float>
    SBK_QTGUI_QLIST_QTEXTLAYOUT_FORMATRANGE_IDX              = 12, // QList<QTextLayout::FormatRange>
    SBK_QTGUI_STD_PAIR_INT_INT_IDX                           = 13, // std::pair<int,int>
    SBK_QTGUI_QLIST_QSTANDARDITEMPTR_IDX                     = 14, // QList<QStandardItem*>
    SBK_QTGUI_QLIST_QSHADERKEY_IDX                           = 15, // QList<QShaderKey>
    SBK_QTGUI_QMAP_INT_STD_PAIR_INT_INT_IDX                  = 16, // QMap<int,std::pair<int,int>>
    SBK_QTGUI_STD_ARRAY_FLOAT_4_IDX                          = 17, // std::array<float,4>
    SBK_QTGUI_QLIST_QRHIVERTEXINPUTATTRIBUTE_IDX             = 18, // QList<QRhiVertexInputAttribute>
    SBK_QTGUI_QLIST_QRHIVERTEXINPUTBINDING_IDX               = 19, // QList<QRhiVertexInputBinding>
    SBK_QTGUI_QLIST_QRHITEXTUREUPLOADENTRY_IDX               = 20, // QList<QRhiTextureUploadEntry>
    SBK_QTGUI_QLIST_QRHICOLORATTACHMENT_IDX                  = 21, // QList<QRhiColorAttachment>
    SBK_QTGUI_STD_ARRAY_INT_4_IDX                            = 22, // std::array<int,4>
    SBK_QTGUI_QLIST_QRHIADAPTERPTR_IDX                       = 23, // QList<QRhiAdapter*>
    SBK_QTGUI_QLIST_QSIZE_IDX                                = 24, // QList<QSize>
    ...
    SBK_QTGUI_QLIST_QFONTVARIABLEAXIS_IDX                    = 35, // QList<QFontVariableAxis>
    ...
    SBK_QTGUI_QLIST_QUNDOSTACKPTR_IDX                        = 48, // QList<QUndoStack*>
    SBK_QTGUI_QLIST_QTEXTFRAMEPTR_IDX                        = 49, // QList<QTextFrame*>
    SBK_QTGUI_QLIST_QTEXTBLOCK_IDX                           = 50, // QList<QTextBlock>
    SBK_QTGUI_QLIST_QTEXTFORMAT_IDX                          = 51, // QList<QTextFormat>
    SBK_QTGUI_QLIST_QSCREENPTR_IDX                           = 52, // QList<QScreen*>
    SBK_QTGUI_QLIST_QOPENGLCONTEXTPTR_IDX                    = 53, // QList<QOpenGLContext*>
    SBK_QTGUI_QSET_QBYTEARRAY_IDX                            = 54, // QSet<QByteArray>
    SBK_QTGUI_QLIST_CONSTQINPUTDEVICEPTR_IDX                 = 55, // QList<const QInputDevice*>
    SBK_QTGUI_QLIST_QACTIONPTR_IDX                           = 56, // QList<QAction*>
    SBK_QTGUI_QLIST_QOBJECTPTR_IDX                           = 57, // QList<QObject*>
    ...
    SBK_QTGUI_QLIST_QBYTEARRAY_IDX                           = 62, // QList<QByteArray>
